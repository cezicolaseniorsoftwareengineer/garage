...
def _build_prompts(
    ...
    system_prompt = (
        ...
        "F. OBRIGATORIO — FENCE JAVA: todo trecho de codigo DEVE estar dentro de um bloco ```java "
        "em linha propria, nunca codigo solto como texto. Nunca escreva codigo Java fora de ```java ... ```. "
        "O bloco DEVE ter a indentacao exata como apareceria num editor profissional (4 espacos por nivel). "
        "O jogador vai copiar e colar direto na IDE — o codigo precisa compilar sem nenhum ajuste.\n"
