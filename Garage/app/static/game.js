...
const StudyChat = {
    ...
    _ensureMounted() {
        ...
        // Ensure exit button exists in dynamically-mounted IDE (cached HTML)
        if (actions && !document.getElementById('ideExitBtn')) {
            const exitBtn = document.createElement('button');
            exitBtn.className = 'ide-btn ide-btn-exit';
            exitBtn.id = 'ideExitBtn';
            exitBtn.onclick = () => IDE.close();
            exitBtn.innerHTML = '<span class="ide-btn-icon">&#8617;</span> SAIR';
    ...
    _renderMarkdown(text) {
        ...
        // Heuristic: line is "clearly Java" — only strong signals, no indented-paragraph catch-all
        const _isCodeLine = (l) =>
            /[;{]\s*$/.test(l) ||
            /^\s*\}[\s;,)]*$/.test(l) ||
    ...
    code_hashmap: {
        ...
        steps: [
            ...
            },
            {
                ...
                helpText: 'COMO EXPANDIR (AMAZON 2/3):\n1. Extraia a logica de busca para um metodo separado.\n2. Retorne o valor como String ou "NOT_FOUND".\n3. Chame o metodo no main alem da iteracao.\n\nCOLA -- Copie este codigo COMPLETO na IDE:\n\nimport java.util.HashMap;\nimport java.util.Map;\n\npublic class HashMapDemo {\n    static String findValue(HashMap<String, Integer> map, String key) {\n        return map.containsKey(key) ? String.valueOf(map.get(key)) : \"NOT_FOUND\";\n    }\n\n    public static void main(String[] args) {\n        HashMap<String, Integer> map = new HashMap<>();\n        map.put(\"Java\", 1995);\n        map.put(\"Python\", 1991);\n        map.put(\"Go\", 2009);\n\n        System.out.println(\"Contem Java: \" + map.containsKey(\"Java\"));\n        System.out.println(\"Python: \" + map.get(\"Python\"));\n        System.out.println(findValue(map, \"Java\"));\n        System.out.println(findValue(map, \"Ruby\"));\n\n        for (Map.Entry<String, Integer> e : map.entrySet()) {\n            System.out.println(e.getKey() + \"=\" + e.getValue());\n        }\n    }\n}'
            },
            {
                ...
                helpText: 'COMO EXPANDIR (AMAZON 3/3):\n1. Verifique se key == null antes de buscar.\n2. Retorne "NOT_FOUND" imediatamente para chave nula.\n3. Teste passando null como argumento.\n\nCOLA -- Copie este codigo COMPLETO na IDE:\n\nimport java.util.HashMap;\nimport java.util.Map;\n\npublic class HashMapDemo {\n    static String findValue(HashMap<String, Integer> map, String key) {\n        if (key == null) return \"NOT_FOUND\";\n        return map.containsKey(key) ? String.valueOf(map.get(key)) : \"NOT_FOUND\";\n    }\n\n    public static void main(String[] args) {\n        HashMap<String, Integer> map = new HashMap<>();\n        map.put(\"Java\", 1995);\n        map.put(\"Python\", 1991);\n        map.put(\"Go\", 2009);\n\n        System.out.println(\"Contem Java: \" + map.containsKey(\"Java\"));\n        System.out.println(\"Python: \" + map.get(\"Python\"));\n        System.out.println(findValue(map, \"Java\"));\n        System.out.println(findValue(map, \"Ruby\"));\n        System.out.println(findValue(map, null));\n\n        for (Map.Entry<String, Integer> e : map.entrySet()) {\n            System.out.println(e.getKey() + \"=\" + e.getValue());\n        }\n    }\n}'
            },
        ],
    },
    ...
    code_fibonacci: {
        ...
        steps: [
            ...
            },
            {
                ...
                objective: 'Extraia para static long fibonacci(int n). Use long, nao int.',
                validator(code) {
                ...
                helpText: 'COMO EXPANDIR (ITAU 2/3):\n1. Extraia o calculo para um metodo reutilizavel.\n2. Use long (nao int) para suportar valores grandes como fibonacci(20)=6765.\n\nCOLA -- Copie este codigo COMPLETO na IDE:\n\npublic class Fibonacci {\n    static long fibonacci(int n) {\n        if (n <= 1) return n;\n        long prev = 0, curr = 1;\n        for (int i = 2; i <= n; i++) {\n            long next = prev + curr;\n            prev = curr;\n            curr = next;\n        }\n        return curr;\n    }\n\n    public static void main(String[] args) {\n        System.out.println(fibonacci(5));\n        System.out.println(fibonacci(10));\n        System.out.println(fibonacci(20));\n    }\n}'
            },
            {
                name: 'Validação de entrada',
                objective: 'Adicione if (n < 0) throw new IllegalArgumentException no inicio do metodo.',
                validator(code) {
                    if (!/<\s*0|<=?\s*-1|< 0/.test(code)) return { ok: false, msg: 'Itau 3/3: verifique se n e negativo com if (n < 0).' };
                    if (!/(return\s*0|return\s*-1|throw)/.test(code)) return { ok: false, msg: 'Itau 3/3: trate n negativo (throw new IllegalArgumentException ou return 0).' };
                    return { ok: true };
                },
                helpText: 'COMO EXPANDIR (ITAU 3/3):\n1. No inicio do metodo, verifique if (n < 0).\n2. Lance IllegalArgumentException ou retorne 0.\n\nCOLA -- Copie este codigo COMPLETO na IDE:\n\npublic class Fibonacci {\n    static long fibonacci(int n) {\n        if (n < 0) throw new IllegalArgumentException("n negativo");\n        if (n <= 1) return n;\n        long prev = 0, curr = 1;\n        for (int i = 2; i <= n; i++) {\n            long next = prev + curr;\n            prev = curr;\n            curr = next;\n        }\n        return curr;\n    }\n\n    public static void main(String[] args) {\n        System.out.println(fibonacci(10));\n        System.out.println(fibonacci(0));\n        try {\n            fibonacci(-1);\n        } catch (IllegalArgumentException e) {\n            System.out.println(e.getMessage());\n        }\n    }\n}'
            },
        ],
    },
    // ---- UBER: Bubble Sort ----
    ...
    code_mergesort: {
        ...
        steps: [
            ...
            },
            {
                ...
                helpText: 'COMO EXPANDIR (NVIDIA 2/3):\n1. Extraia toda logica de mescla para static void merge(int[], int, int, int).\n2. merge recebe: l=inicio, m=meio, r=fim do segmento.\n3. Aloque arrays temporarios L[] e R[] para copiar as metades.\n4. Percorra comparando elemento a elemento, copiando o menor.\n\nCOLA -- Copie este codigo COMPLETO na IDE:\n\nimport java.util.Arrays;\n\npublic class MergeSort {\n    static void merge(int[] arr, int l, int m, int r) {\n        int n1 = m - l + 1;\n        int n2 = r - m;\n        int[] L = new int[n1];\n        int[] R = new int[n2];\n\n        for (int i = 0; i < n1; i++) L[i] = arr[l + i];\n        for (int j = 0; j < n2; j++) R[j] = arr[m + 1 + j];\n\n        int i = 0, j = 0, k = l;\n        while (i < n1 && j < n2) {\n            if (L[i] <= R[j]) arr[k++] = L[i++];\n            else arr[k++] = R[j++];\n        }\n        while (i < n1) arr[k++] = L[i++];\n        while (j < n2) arr[k++] = R[j++];\n    }\n\n    static void mergeSort(int[] arr, int l, int r) {\n        if (l < r) {\n            int mid = (l + r) / 2;\n            mergeSort(arr, l, mid);\n            mergeSort(arr, mid + 1, r);\n            merge(arr, l, mid, r);\n        }\n    }\n\n    public static void main(String[] args) {\n        int[] arr = {38, 27, 43, 3, 9, 82, 10};\n        mergeSort(arr, 0, arr.length - 1);\n        System.out.println(Arrays.toString(arr));\n    }\n}'
            },
            {
    ...
    code_reverse: {
        ...
        steps: [
            ...
            },
            {
                ...
                objective: 'Extraia para static ListNode reverseList(ListNode head).',
                validator(code) {
                    if (!/static\s+ListNode\s+\w+\s*\(\s*ListNode/.test(code)) return { ok: false, msg: 'Bradesco 2/3: crie metodo static ListNode reverseList(ListNode).' };
                    return { ok: true };
                },
